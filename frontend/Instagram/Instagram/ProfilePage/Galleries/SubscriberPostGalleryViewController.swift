//
//  SubscriberPostGalleryViewController.swift
//  InstagramClone
//
...
class SubscriberPostGalleryViewController: GalleryViewController {
    
    private let cellID = "subscriberPostCell"
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ActiveUser.loggedIn.first!.subscriberPosts.count
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        postView.post = ActiveUser.loggedIn.first!.subscriberPosts[indexPath.item]
        return postView
    }
